# Target Researchers for Collaboration
...
- **Why:** Pioneer of in vivo LNP-delivered base editing. Connected to the February 2026 FDA framework for gene therapies.
- **Ask:** Technical feasibility assessment of ABE/CBE for MTHFR C677T/A1298C, delivery strategy for hepatic vs retinal vs CNS application.

### Dr. David Liu — Broad Institute / Harvard
- **Why:** Invented adenine base editors (ABE) and cytosine base editors (CBE) — the exact technology this project proposes to use.
- **Ask:** Guide RNA design consultation, feasibility of single-base correction at the MTHFR locus.

## Priority 5: Ophthalmology Research Centers
